...
import {
  ...
  listPublic,
  listForAttendees,
} from '../../modules/conferences/conferences.controller';
...
// Attendee access for upcoming events (no special permissions required)
conferencesRouter.get('/attendees', auth(), listForAttendees);
...
conferencesRouter.post(
  '/',
  auth(),
  rbac('conferences.create'),
  audit('conference', 'create', 'conference'),
  create
);
...
conferencesRouter.patch(
  ...
  audit('conference', 'update', 'conference'),
  update
);
conferencesRouter.patch(
  '/:id/status',
  auth(),
  rbac('conferences.update'),
  audit('conference', 'status', 'conference'),
  changeStatus
);
conferencesRouter.delete(
  '/:id',
  auth(),
  rbac('conferences.delete'),
  audit('conference', 'delete', 'conference'),
  remove
);
