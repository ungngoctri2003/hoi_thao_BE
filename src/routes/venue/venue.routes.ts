...
venueRouter.post('/conferences/:confId/floors', auth(), rbac('conferences.update'), audit('conference', 'floor-create', 'floor'), async (req, res, next) => {
...
venueRouter.delete('/floors/:id', auth(), rbac('conferences.update'), audit('conference', 'floor-delete', 'floor'), async (req, res, next) => {
...
venueRouter.post('/floors/:floorId/rooms', auth(), rbac('conferences.update'), audit('conference', 'room-create', 'room'), async (req, res, next) => {
...
venueRouter.delete('/rooms/:id', auth(), rbac('conferences.update'), audit('conference', 'room-delete', 'room'), async (req, res, next) => {
